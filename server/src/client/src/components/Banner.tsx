    ...
    >
      ...
      <div className="relative h-full max-w-7xl mx-auto flex items-center">
        <div className="max-w-xl text-white">
          <span className="tracking-[6px] uppercase">Bộ sưu tập đặc biệt</span>
          ...
          <p className="mt-8 leading-8 text-gray-200">
            Chúng tôi mang đến những mùi hương được tuyển chọn từ các thương
            hiệu nổi tiếng trên thế giới với chất lượng chính hãng và dịch vụ
            cao cấp.
          </p>
