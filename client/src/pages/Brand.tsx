      ...
      <section className="px-6 pb-10 pt-16 sm:px-10 lg:px-16 lg:pb-14 lg:pt-24">
        <div className="mx-auto max-w-[1420px]">
          ...
          <p className="mt-8 max-w-[670px] text-sm leading-7 text-[#69665F] lg:mt-10">
            From the historic ateliers of Paris to the avant-garde laboratories
            of Stockholm, we present a collection of the world&apos;s most
            distinguished perfumeries. Each brand in our portfolio is selected
            for its architectural approach to scent and uncompromising
            commitment to the olfactory arts.
          </p>
